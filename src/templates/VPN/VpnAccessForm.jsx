// src/templates/TemplateA.jsx
import React from "react";
import "./VpnAccessForm.css";
import FormHeader from "../../components/FormHeader/FormHeader";
import FormCommonDetails from "../../components/FormCommonDetails/FormCommonDetails";
import FormSign from "../../components/FormSign/FormSign";
function VpnAccessForm({ form, formData , apiDetails }) {
  
  return (
    <div className="vpn-access-form-main-container">
     
      <FormHeader form={form} code="JAPFA/IT/DOC/14" page="1|1" issue_date="02.01.2020"/>
